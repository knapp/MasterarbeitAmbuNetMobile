...
\newcommand{\mytitle}{\iflanguage{english}{Title}{Entwicklung eines mobilen Software-Assistenten zur Unterstützung der vernetzten Pflege}}
...
\include{text/entwurfsentscheidungen}
...
\cleardoublepage
\phantomsection
\addcontentsline{toc}{chapter}{Hallo}
