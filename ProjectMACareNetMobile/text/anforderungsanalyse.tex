...
Hintergrund ist ein mögliches Sicherheitsproblem, wenn Code, der eigentlich von einem vertrauenswürdigen Server geladen
wurde, lokal gespeicherte Daten ausliest (wie z.B. Zugangsdaten) und an eine andere nicht vertrauenswürdige Adresse
